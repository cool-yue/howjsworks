...
// 这个模型的一个没想到的收益是JavaScript在web浏览器中是非常好地有适应力
...
// 触犯这个轮次的规则就会把一个高性能的事件系统转换成了一个低性能的心痛
 ...
 */
 ...
 // 我们应该模块地设计.每个单元的工作,可能是创建一个某些服务器或者数据库或者启动一个进程的请求,这些应该是分开的函数
 ...
 // 我们使用单词requestor来标书一个函数接受一个回调和进行一个工作单元,这个工作单元知道未来的一个turn的时候才完成。
